...
<?php }?>
          ...
          <div class="w3-col s4 w3-center"> <a href="modules/xuli/confirm.php?id=<?php echo $request_id ?>">Chấp nhận</a></div>
          <div class="w3-col s4 w3-center"> <a href="modules/xuli/cancel.php?id=<?php echo $request_id ?>">Hủy bỏ</a></div>
