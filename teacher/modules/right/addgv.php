...
<body>
  ...
  <div class="container w3-sand">
    <form action="modules/xuli/add_teacher.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-25">
          <label for="fname">Tên Giáo Viên</label>
        </div>
        <div class="col-25">
      ...
      <div class="row">
        <div class="col-25">
          <label for="fname">Mã giáo viên</label>
        </div>
        <div class="col-25">
      ...
      <div class="row">
        ...
        <div class="col-25">
          <select class="w3-select" name="gioitinh">
