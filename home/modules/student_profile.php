...
?>
       ...
       <div class="w3-col s6">
          ...
          <div class="w3-col ">
            ...
            <div class="w3-row">  <h3 style="margin-left:5px;">Năng lực</h3></div>
...
<?php }?>
          ...
          <div class="w3-row">  
              <button> <a href="layout_student.php?xem=update_student_profile"  >Cập nhât thông tin</a></button>
          </div>
          <div class="w3-row">  
              <button> <a href="layout_student.php?xem=update_pass_student"  >Cập nhât mật khẩu</a></button>
          </div>
          <div class="w3-row">  
              <button> <a href="layout_student.php?xem=add_capacity_student"  >Them nang luc</a></button>
          </div>
