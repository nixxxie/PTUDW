...
<div class="w3-col s6">
  <div class="w3-row">
      <div class="w3-row">
        <p style="margin-left:5px;font-size:24px; font-weight: bold;">Năng lực</p>
      </div>
    ...
    ?>
    <div class="w3-row">
      <a class="w3-button w3-light-green" style="border-radius : 5px;" href="layout_enterprise.php?xem=chitiet&id=<?php echo $request_id; ?>"> Trở về</a>
    </div>