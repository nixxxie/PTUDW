...
?>
         ...
         <img src="modules/xuli/uploads/img1.PNG " height="250px" width="200px">
          ...
          <p>Số lượng nhân viên : <?php echo  $row['employee_count'];?></p>
           ...
           <div class="w3-row">  
              <button> <a href="layout_enterprise.php?xem=update_enterprise_profile"  >Cập nhât thông tin</a></button>
          </div>
          <div class="w3-row">  
              <button> <a href="layout_enterprise.php?xem=update_pass_enterprise"  >Cập nhât mật khẩu</a></button>
          </div>

       </div>
         <div class="w3-row">  
              <button> <a href="layout_enterprise.php?xem=list_request_enterprise"  >Tro ve</a></button>
          </div>     
